...
const HomePage:React.FC = ()=> {
  ...
  <nav className="bg-blue-600 p-4">
    ...
    <Link  to='/' className='text-white text-2xl font-bold'>My Library</Link>
      <div>
      <Link  to='/myBooks' className='text-white hover:text-gray-200 mx-2'>My Books</Link>
    {/* <Link  to='/addMember' className='text-white hover:text-gray-200 mx-2'>Add Member</Link> */}
